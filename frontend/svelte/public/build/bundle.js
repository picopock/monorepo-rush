...
var app = (function () {
    ...
    /* src/TodoList.svelte generated by Svelte v3.44.1 */
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" x ");
    			t2 = text(t2_value);
    			add_location(li, file$1, 21, 4, 387);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button1.textContent = "-";
    			add_location(h1, file$1, 18, 0, 332);
    			add_location(ul, file$1, 19, 0, 351);
    			add_location(button0, file$1, 24, 0, 437);
    			add_location(button1, file$1, 25, 0, 481);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 20, 2, 308);
    			add_location(p0, file, 21, 2, 333);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 22, 15, 372);
    			add_location(p1, file, 22, 2, 359);
    			add_location(br, file, 25, 19, 495);
    			add_location(p2, file, 24, 2, 472);
    			add_location(button0, file, 28, 2, 534);
    			add_location(button1, file, 29, 2, 580);
    			attr_dev(main, "class", "svelte-1e9puaw");
    			add_location(main, file, 19, 0, 299);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('dCount' in $$props) $$invalidate(5, dCount = $$props.dCount);
    	...
    	return [name, count, ddCount, onIncrement, onDecrement, dCount];
    }
